--
-- config\binding_profile.lua
--
local _, store = ...
store.config = store.config or {}

store.config.binding_profile = {
    -- Movement Keys
    ["MOVEANDSTEER"] = "", -- first CMD, second KEY
    ["MOVEFORWARD"] = "W",
    ["MOVEBACKWARD"] = "S",
    ["TURNLEFT"] = "LEFT", -- LEFT - need for break follow
    ["TURNRIGHT"] = "RIGHT", -- RIGHT - need for break follow
    ["STRAFELEFT"] = "A",
    ["STRAFERIGHT"] = "D",
    ["JUMP"] = "SPACE",
    ["SITORSTAND"] = "",
    ...
    ["MULTIACTIONBAR1BUTTON1"] = "1", -- BottomLeft Action Button 1
    ["MULTIACTIONBAR1BUTTON2"] = "2",
    ["MULTIACTIONBAR1BUTTON3"] = "3",
    ["MULTIACTIONBAR1BUTTON4"] = "4",
    ["MULTIACTIONBAR1BUTTON5"] = "5",
    ["MULTIACTIONBAR1BUTTON6"] = "6",
    ["MULTIACTIONBAR1BUTTON7"] = "7",
    ["MULTIACTIONBAR1BUTTON8"] = "8",
    ["MULTIACTIONBAR1BUTTON9"] = "9",
    ["MULTIACTIONBAR1BUTTON10"] = "0",
